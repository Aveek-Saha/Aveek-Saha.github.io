...
Main.prototype = {
	...
	create: function() {
		...
		this.bgHeight = this.game.cache.getImage('bg5').height;
		this.bgWidth = this.game.cache.getImage('bg5').width;

		this.scale = Math.ceil(window.outerWidth / this.bgWidth);
